...
export function FormAddImage({ closeModal }: FormAddImageProps): JSX.Element {
  ...
  const mutation = useMutation<unknown, unknown, ImageProps>(
    formData => api.post('/api/images', formData),
    {
  ...
  const onSubmit = async ({ description, title }: FormData): Promise<void> => {
    try {
      if (!imageUrl) {
        toast({
